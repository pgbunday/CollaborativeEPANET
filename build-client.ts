...
if (error) {
    ...
    const result = await build({
        entryPoints: ["src/client/client.tsx", "src/client/create_project.tsx", "src/client/projects.css"],
        minify: false,
        bundle: true,
        outdir: "build-client",
        plugins: [
    ...
    if (result.metafile) {
        await writeFile('./build-client/meta.json', JSON.stringify(result.metafile));
    }
}