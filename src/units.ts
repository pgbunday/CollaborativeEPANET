...
export function convert_length(amount: Length, out: (x: number) => Length): number {
...
export function add(unit1: Unit, unit2: Unit): Unit {
    if (unit1.kilograms === unit2.kilograms && unit1.meters === unit2.meters && unit1.seconds === unit2.meters) {
        return {
            ...unit1,
