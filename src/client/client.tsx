...
function ShareModal({ open, setOpen }: { open: boolean, setOpen: (value: boolean) => void }) {
    const dialogRef: RefObject<HTMLDialogElement | null> = useRef(null);
    const [username, setUsername] = useState("");
    return (
        <div>
            <button onClick={() => { dialogRef.current?.showModal(); setOpen(true) }}>Share</button>
...
function Toolbar() {
    ...
    return <div class="toolbar">
        ...
        <div class="toolbar-right">
            ...
            <HistoryModal open={historyOpen} setOpen={setHistoryOpen} mapState={mapState} />
