import { z } from "zod";
import { AddJunctionData, AddPipeData, AddReservoirData, AddTankData, LinkStatus, PipePropertiesData, ReservoirPropertiesData, TankPropertiesData } from "./common.js";
