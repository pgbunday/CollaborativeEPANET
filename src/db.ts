...
db.exec('CREATE TABLE IF NOT EXISTS projects (uuid TEXT NOT NULL UNIQUE PRIMARY KEY, name TEXT NOT NULL, owner_uuid TEXT NOT NULL, inp_file TEXT NOT NULL, created_at TEXT NOT NULL, modified_at TEXT NOT NULL, longitude REAL NOT NULL, latitude REAL NOT NULL, zoom REAL NOT NULL)');
